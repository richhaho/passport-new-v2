...
const routes = [
    ...
    {
        path: 'contacts',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-contacts-contacts-module */ "pages-contacts-contacts-module").then(__webpack_require__.bind(null, /*! ./pages/contacts/contacts.module */ "./src/app/pages/contacts/contacts.module.ts"))
            .then(mod => mod.ContactsModule)
    },
    {
        path: 'bookings',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-bookings-bookings-module */ "pages-bookings-bookings-module").then(__webpack_require__.bind(null, /*! ./pages/bookings/bookings.module */ "./src/app/pages/bookings/bookings.module.ts"))
...
let AppComponent = class AppComponent {
    constructor(toast, api, modalService, auth) {
        this.toast = toast;
        this.api = api;
        ...
        this.notifications = []; /** @todo Make notificatons interface and workings */
    }
    ngOnInit() {
        this.nowYear();
    }
...
/* harmony import */ var ngx_ui_loader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-ui-loader */ "./node_modules/ngx-ui-loader/fesm2015/ngx-ui-loader.js");
...
/* harmony import */ var _demo_modules_demo_utils_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../demo-modules/demo-utils/module */ "./src/demo-modules/demo-utils/module.ts");
/* harmony import */ var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-bootstrap/timepicker */ "./node_modules/ngx-bootstrap/timepicker/fesm2015/ngx-bootstrap-timepicker.js");
...
/* harmony import */ var ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ngx-bootstrap/accordion */ "./node_modules/ngx-bootstrap/accordion/fesm2015/ngx-bootstrap-accordion.js");
/* harmony import */ var _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @kolkov/angular-editor */ "./node_modules/@kolkov/angular-editor/fesm2015/kolkov-angular-editor.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            angular_calendar__WEBPACK_IMPORTED_MODULE_16__["CalendarModule"].forRoot({ provide: angular_calendar__WEBPACK_IMPORTED_MODULE_16__["DateAdapter"], useFactory: angular_calendar_date_adapters_date_fns__WEBPACK_IMPORTED_MODULE_17__["adapterFactory"] }),
            angularx_flatpickr__WEBPACK_IMPORTED_MODULE_18__["FlatpickrModule"],
            _demo_modules_demo_utils_module__WEBPACK_IMPORTED_MODULE_19__["DemoUtilsModule"],
            ...
            ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_25__["AccordionModule"].forRoot(),
            ng2_slim_loading_bar__WEBPACK_IMPORTED_MODULE_27__["SlimLoadingBarModule"]
        ],
        providers: [
            {
...
let LoginComponent = class LoginComponent {
    constructor(router, toast, api, auth) {
        this.router = router;
        this.toast = toast;
        this.api = api;
        this.auth = auth;
    ...
    submitLogin() {
        if (this.loginForm.valid) {
            ...
            this.api.post('user/login', userData).subscribe((response) => {
...
let ApiService = class ApiService {
    ...
    get(endpoint, headers = {}) {
        ...
        const call = this.httpClient.get(this.url + endpoint, {});
        return call;
    }
    /**
     *
    ...
    post(endpoint, data = {}, headers = {}) {
        ...
        const httpHeaders = new HttpHeaders({...basicHeaders, ...headers});*/
        const call = this.httpClient.post(this.url + endpoint, data, {});
        return call;
    }
    /**
     *
...
let AuthService = class AuthService {
     ...
     */
    setUserToStorage(user, updateActiveSession = true) {
...
let CustomInterceptor = class CustomInterceptor {
    constructor(loader, router, toast, auth) {
        this.loader = loader;
        this.router = router;
        this.toast = toast;
        this.auth = auth;
    ...
    intercept(req, next) {
        ...
        return next.handle(cloneReq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(event => {
...
/* harmony import */ var _calendar_header_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./calendar-header.component */ "./src/demo-modules/demo-utils/calendar-header.component.ts");
...
module.exports = __webpack_require__(/*! G:\passport-new-v2\frontend\src\main.ts */"./src/main.ts");
